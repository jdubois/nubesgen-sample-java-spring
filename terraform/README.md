...
```
curl "http://localhost:8080/demo.tgz?iactool=TERRAFORM&region=westeurope&application=APP_SERVICE.standard&runtime=SPRING&database=NONE.free&gitops=true" | tar -xzvf -
```
